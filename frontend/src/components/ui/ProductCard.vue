...
<template>
  <RouterLink class="card" :to="`/p/${item.slug}`" style="display:block;">
    <div style="aspect-ratio: 4 / 3; overflow:hidden; border-radius:10px; background:#f1f5f9; border:1px solid #e2e8f0;">
      <img
